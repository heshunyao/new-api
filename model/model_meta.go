...
type Model struct {
	...
	UrlExtractor string         `json:"url_extractor,omitempty" gorm:"type:text"`
...
func (mi *Model) Update() error {
	...
	return DB.Model(&Model{}).Where("id = ?", mi.Id).
		Select("model_name", "description", "icon", "tags", "vendor_id", "endpoints", "url_extractor", "status", "sync_official", "name_rule", "updated_time").
		Updates(mi).Error
}
